<template>
    <div v-if="phoneWidth <= 561">
        <div class="d-flex" v-if="this.getPackage && this.getPackage.length > 0"
            ...
            <div class="d-flex flex-column justify-start text-center align-start px-1" style="width: 90vw; margin-top:10px">               

                <div class="text-subtitle-1 justify-start text-start align-center">
                    <p class="text-caption text--disabled" style="width: 90vw height:100%">
                        <!-- {{ item.subtitle }} -->
                        {{ this.packageObj[0].package_description }}
                    </p>
                </div>

                <div class="d-flex justify-start align-center mb-5 mt-3">
            ...
            <div class="d-flex flex-row justify-start" style="align-items: center; padding:10px">
                ...
                <div class="text-subtitle-1 round-md">
                    ...
                    <v-btn depressed color="white" :style="ButtonColor"
                        @click="gotoSubscriptionUrl(this.packageObj[0].package_subscription_url)">
                        Access Option
                    </v-btn>
                </div>
            </div>
    ...
    <div v-else>
        <div class="d-flex" v-if="this.getPackage && this.getPackage.length > 0"
            style="margin-top:150px;margin-left: 100px;" @click="navigationStateChange()">
            <v-img :src="isDev ? CardVod : this.packageObj[0].package_image" width="400" style="border-radius: 10px;"></v-img>

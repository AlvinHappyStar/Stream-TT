<template>
  <swiper
    ...
    :spaceBetween="cardSpaceMargin"
    :modules="modules"
    :observer="true"
    :observeParents="true"
    :parallax="true"
    class="mySwiper bg-none pl-5 pr-5 py-5"
  >
    <swiper-slide
    ...
    >
      ...
      <!-- item.poster_url -->
      <v-img
        :src="isDev ? CardVod : item.poster_url"
        :class="item.package_status ? card_vod_img : card_vod_img_disabled"
        :title="item.caption"

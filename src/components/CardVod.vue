<template>
    <swiper :slidesPerView="getSlides" :spaceBetween="cardSpaceMargin" :modules="modules" :observer="true"
        :observeParents="true" :parallax="true" navigation="navigation" class="mySwiper bg-none pl-5 pr-5 py-5">

<template>
    <v-app-bar class="d-flex justify-space-between align-baseline"
        ...
        <div style="display: flex; justify-content: flex-start;align-items: center;width: 30%;">
        ...
        <div class="d-flex justify-end align-center mr-10" style="width: 90% ;" @click="navigationChange()" id="menu_hidden">
